# -*- encoding: utf-8 -*-
# stub: logstash-output-kafka 0.1.9 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<ruby-maven>, ["= 3.1.1.0.8"])
      s.add_runtime_dependency(%q<maven-tools>, ["= 1.0.7"])
      ...
      s.add_dependency(%q<ruby-maven>, ["= 3.1.1.0.8"])
      s.add_dependency(%q<maven-tools>, ["= 1.0.7"])
